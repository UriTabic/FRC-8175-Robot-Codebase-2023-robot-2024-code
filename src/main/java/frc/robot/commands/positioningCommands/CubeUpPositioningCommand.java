...
public class CubeUpPositioningCommand extends Command {
    private RamseteCommand command;
    private DriveSubsystem mDriveSubsystem;
    private TrajectoryFactory mFactory;
    public CubeUpPositioningCommand(DriveSubsystem drive, TrajectoryFactory factory){
    ...
    //         mDriveSubsystem.getPoseTarget(AutoMode.kCubeUp),
    //         false),
    //     mDriveSubsystem::getPose,

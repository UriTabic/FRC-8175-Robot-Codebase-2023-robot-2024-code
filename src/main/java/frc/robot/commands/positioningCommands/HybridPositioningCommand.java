...
public class HybridPositioningCommand extends Command {
    private RamseteCommand command;
    private DriveSubsystem mDriveSubsystem;
    private TrajectoryFactory mFactory;
    public HybridPositioningCommand(DriveSubsystem drive, TrajectoryFactory factory){
    ...
    //         mDriveSubsystem.getPoseTarget(AutoMode.kHybrid),
    //         false),
    //     mDriveSubsystem::getPose,
